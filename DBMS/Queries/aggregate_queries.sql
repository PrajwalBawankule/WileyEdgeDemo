...
select count(productCode) as total from Products;
+-------+
| total |
+-------+
|   110 |
...
select productCode, sum(MSRP) from products group by productCode;
+-------------+-----------+
| productCode | total     |
+-------------+-----------+
| S18_3232    | 276839.98 |
...
INNER JOIN customers
    ON customers.salesRepEmployeeNumber = salesRepEmployeeNumber
...
--Calculate the average buy price of the average buy prices of the product lines;
